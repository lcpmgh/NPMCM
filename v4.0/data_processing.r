...
data_dir <- function(name = NULL){paste0(getwd(), '/v4.0/shiny_app/data/', name)}             #数据文件路径
...
# 手动查漏补缺步骤：
# 此函数，若输出结果中，存在NA值，则哟两种情况：1有新的培养单位参加，2旧的培养单位出现新的不规范名字
...
unit_info_dataset <- unit_info_genrating(crawler = F)
