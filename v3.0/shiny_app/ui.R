...
ui <- fluidPage(
  ...
  tabsetPanel(
    ...
    tabPanel('By team',
             ...
             h3("获奖数量年际变化", align = "center"),
             loadEChartsTheme("shine"),
             tags$div(id = "plot_13", style = "width:100%;height:300px;"),
             deliverChart(div_id = "plot_13"),
             tags$hr(),
             
             h3("获奖题型构成比例年际变化（单位%）", align = "center"), 
             loadEChartsTheme("infographic"),
             tags$div(id="plot_14", style = "width:100%;height:300px;"),
             deliverChart(div_id = "plot_14"),
    ...
    tabPanel('By member',
             dropdownButton(tags$h4(tags$b("参数选项")), 
                            ...
                            sliderTextInput(inputId = "inp_22", label = "年份区间", choices = 2004:2020, selected = c(2004,2020)),
    ...
    tabPanel('Award Series',
             dropdownButton(tags$h4(tags$b("参数选项")), circle = T, status = "success", icon = icon("gear"), width = "300px",
                            ...
                            sliderTextInput(inputId = "inp_32", label = "年份区间", choices = 2004:2020, selected = c(2004, 2020)),
    ...
    tabPanel('Award database',
             ...
             sidebarLayout(
               sidebarPanel(width = 3,
                            ...
                            tags$hr(),
                            h6("由于底层数据为UTF-8，但是GUI显示和输入为GB2312，导致右侧search查询功能不能用了")
               ),
